...
Description: Description: Administrative options for ML-ContactForm
...
$location = get_option('siteurl') . '/wp-admin/admin.php?page=multilang-contactform/options-contactform.php'; // Form Action URI
